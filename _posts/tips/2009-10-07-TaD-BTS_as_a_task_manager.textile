...
The following examples use an older version of @be@ that you can download as a "tarball":http://www.jnrowe.ukfsn.org/_static/be-0.0.193.tar.bz2 and doesn't require @bzr@.  As stated above, if you're using "Gentoo":http://www.gentoo.org/ you can use the @dev-util/be@ ebuild in my "overlay":http://github.com/jnrowe/misc-overlay.
