...
Matt Turner's reply sums up the general feeling quite nicely:

bq. Just use whatever server you have installed already.  If don't have _any_ installed grab "nginx":http://nginx.net/ as it works well and is quite small.
