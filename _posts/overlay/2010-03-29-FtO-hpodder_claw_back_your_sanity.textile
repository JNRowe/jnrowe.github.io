...
If you haven't already installed @ghc@ you may wish to consider installing the binary version with @USE=binary@, as @ghc@ can take an awful long time to build.
...
On initial run @hpodder@ will ask where it should store downloaded podcasts, and offer to subscribe to some sample feeds.  I'd suggest skipping the samples and adding your own feeds straight away:
