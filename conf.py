# -*- coding: utf-8 -*-
#
# JNRowe documentation build configuration file, created by
...
# [howto/manual]).
latex_documents = [
  ('index', 'JNRowe.tex', u'JNRowe Documentation',
   u'James Rowe', 'manual'),
]
...
man_pages = [
    ('index', 'jnrowe', u'JNRowe Documentation',
     [u'James Rowe'], 1)
]
...
texinfo_documents = [
  ('index', 'jnrowe', u'JNRowe Documentation',
   u'James Rowe', 'JNRowe', 'One line description of project.',
   'Miscellaneous'),
]
